...
class MrpProductionSchedule(models.Model):
    ...
    def action_open_actual_demand_details(self, date_str, date_start_str, date_stop_str):
        ...
        return {
            ...
            'view_mode': 'list,form',
            'name': _('Actual Demand %(product)s %(date)s (%(date_start)s - %(date_end)s)', product=self.product_id.display_name, date=date_str, date_start=date_start_str, date_end=date_stop_str),
            'target': 'current',
