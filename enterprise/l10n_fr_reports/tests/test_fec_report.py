...
class TestAccountFrFec(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        with freeze_time('2021-05-02'):
            ...
            cls.wizard = cls.env['l10n_fr.fec.export.wizard'].create({
                'date_from': fields.Date.today() - timedelta(days=1),
                'date_to': fields.Date.today(),
                'export_type': 'official',
                'test_file': True,
            })
            cls.wizard_id = {'l10n_fr_reports_fec_wizard_id': cls.wizard.id}
        ...
        cls.report = cls.env['account.general.ledger.report.handler']
